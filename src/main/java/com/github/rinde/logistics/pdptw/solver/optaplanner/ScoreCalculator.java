...
//      }
//      System.out.println("tempHardScore "+tempHardScore);
//      System.out.println("------------------------");
//    }
...
//      long loadHardscore = getOverload(load,pv.getVehicle().getCapacity());
//      if(pv.getPreviousVisit().getClass().equals(ParcelVisit.class)) {
//        loadHardscore += loadHardScores.get(pv.getVehicle());
//      }
//      loadHardScores.put(pv.getVehicle(),loadHardscore);
...
//  private long getOverload(long newLoad, int capacity) {
//    if (capacity - newLoad >= 0){
//      return 0;
//    } else {
//      System.out.println("+++++++++++++++++++++++++overload+++++++++++++++++++++++++++++++");
//      return newLoad-capacity;
//    }
//  }
